...
def register_guild_scoped_context_menus(
    ...
    *,
    ...
    """Register context menus only for guilds listed in BOT_SHOULD_IN_GUILD_IDS."""
...
def remove_guild_scoped_context_menus(tree, commands: Sequence) -> None:
    """Remove guild-scoped context menus registered via BOT_SHOULD_IN_GUILD_IDS."""
